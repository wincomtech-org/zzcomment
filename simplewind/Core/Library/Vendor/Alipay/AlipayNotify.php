...
class AlipayNotify {
	...
	function getSignVeryfy($para_temp, $sign) {
		...
		switch (strtoupper(trim($this->alipay_config['sign_type']))) {
			case "MD5" :
			    logResult('md5'.$isSgin);
				$isSgin = md5Verify($prestr, $sign, $this->alipay_config['key']);
				logResult('$prestr'.$prestr);
				logResult('$sign'.$sign);
				logResult('key'.($this->alipay_config['key']));
				logResult('$$isSgin'.$isSgin);
				break;
			default :
				$isSgin = false;
		}
